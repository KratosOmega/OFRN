...
"""autogenerated by genpy from pacmod_msgs/SystemRptBool.msg. Do not edit."""
import sys
...
class SystemRptBool(genpy.Message):
  _md5sum = "843d7a149b32373c9508d0ea0544b94a"
  _type = "pacmod_msgs/SystemRptBool"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SystemRptBool, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_10B().pack(_x.enabled, _x.override_active, _x.command_output_fault, _x.input_output_fault, _x.output_reported_fault, _x.pacmod_fault, _x.vehicle_fault, _x.manual_input, _x.command, _x.output))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.enabled, _x.override_active, _x.command_output_fault, _x.input_output_fault, _x.output_reported_fault, _x.pacmod_fault, _x.vehicle_fault, _x.manual_input, _x.command, _x.output,) = _get_struct_10B().unpack(str[start:end])
