...
"""autogenerated by genpy from ibeo_msgs/HostVehicleState2807.msg. Do not edit."""
import sys
...
class HostVehicleState2807(genpy.Message):
  _md5sum = "e2e6eff0bfef8ba9587eece105e62bf5"
  _type = "ibeo_msgs/HostVehicleState2807"
...
"""
  ...
  _slot_types = ['std_msgs/Header','ibeo_msgs/IbeoDataHeader','time','int32','int32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HostVehicleState2807, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2IBH4I2i15f().pack(_x.ibeo_header.previous_message_size, _x.ibeo_header.message_size, _x.ibeo_header.device_id, _x.ibeo_header.data_type_id, _x.ibeo_header.stamp.secs, _x.ibeo_header.stamp.nsecs, _x.timestamp.secs, _x.timestamp.nsecs, _x.distance_x, _x.distance_y, _x.course_angle, _x.longitudinal_velocity, _x.yaw_rate, _x.steering_wheel_angle, _x.cross_acceleration, _x.front_wheel_angle, _x.vehicle_width, _x.vehicle_front_to_front_axle, _x.rear_axle_to_front_axle, _x.rear_axle_to_vehicle_rear, _x.steer_ratio_poly_0, _x.steer_ratio_poly_1, _x.steer_ratio_poly_2, _x.steer_ratio_poly_3, _x.longitudinal_acceleration))
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_2IBH4I2i15f = None
def _get_struct_2IBH4I2i15f():
    global _struct_2IBH4I2i15f
    if _struct_2IBH4I2i15f is None:
        _struct_2IBH4I2i15f = struct.Struct("<2IBH4I2i15f")
    return _struct_2IBH4I2i15f
