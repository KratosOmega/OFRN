...
"""autogenerated by genpy from delphi_mrr_msgs/TrackMotionPower.msg. Do not edit."""
import sys
...
class TrackMotionPower(genpy.Message):
  _md5sum = "60d9d46dbc2553e20af8f241eeeae906"
  _type = "delphi_mrr_msgs/TrackMotionPower"
...
string frame_id
"""
  __slots__ = ['header','movableFast','movableSlow','moving','power']
  _slot_types = ['std_msgs/Header','bool','bool','bool','int8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,movableFast,movableSlow,moving,power
