...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.goal_footstep.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.initial_footstep.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_result.result.result.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_feedback.feedback.feedback.header.frame_id = str[start:end].decode('utf-8')
      else:
