...
(cl:in-package automotive_navigation_msgs-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <GetImageForMapTile-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetImageForMapTile-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name automotive_navigation_msgs-srv:<GetImageForMapTile-request> is deprecated: use automotive_navigation_msgs-srv:GetImageForMapTile-request instead.")))

(cl:ensure-generic-function 'tile_id-val :lambda-list '(m))
(cl:defmethod tile_id-val ((m <GetImageForMapTile-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_navigation_msgs-srv:tile_id-val is deprecated.  Use automotive_navigation_msgs-srv:tile_id instead.")
  (tile_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetImageForMapTile-request>)))
  ...
  "automotive_navigation_msgs/GetImageForMapTileRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetImageForMapTile-request)))
  "Returns string type for a service object of type 'GetImageForMapTile-request"
  "automotive_navigation_msgs/GetImageForMapTileRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetImageForMapTile-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetImageForMapTile-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name automotive_navigation_msgs-srv:<GetImageForMapTile-response> is deprecated: use automotive_navigation_msgs-srv:GetImageForMapTile-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <GetImageForMapTile-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_navigation_msgs-srv:success-val is deprecated.  Use automotive_navigation_msgs-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <GetImageForMapTile-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_navigation_msgs-srv:message-val is deprecated.  Use automotive_navigation_msgs-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetImageForMapTile-response>)))
  ...
  "automotive_navigation_msgs/GetImageForMapTileResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetImageForMapTile-response)))
  "Returns string type for a service object of type 'GetImageForMapTile-response"
  "automotive_navigation_msgs/GetImageForMapTileResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetImageForMapTile)))
  ...
  "automotive_navigation_msgs/GetImageForMapTile")