...
(cl:defmethod cl:initialize-instance :after ((m <Direction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Direction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name automotive_navigation_msgs-msg:<Direction> is deprecated: use automotive_navigation_msgs-msg:Direction instead.")))
...
(cl:defmethod direction-val ((m <Direction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_navigation_msgs-msg:direction-val is deprecated.  Use automotive_navigation_msgs-msg:direction instead.")
  (direction m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Direction>)))
  ...
  "automotive_navigation_msgs/Direction")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Direction)))
  "Returns string type for a message object of type 'Direction"
  "automotive_navigation_msgs/Direction")
