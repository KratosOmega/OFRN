...
(cl:defclass <PointOfInterestArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (point_list
    :reader point_list
    :initarg :point_list
    :type (cl:vector automotive_navigation_msgs-msg:PointOfInterest)
   :initform (cl:make-array 0 :element-type 'automotive_navigation_msgs-msg:PointOfInterest :initial-element (cl:make-instance 'automotive_navigation_msgs-msg:PointOfInterest))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PointOfInterestArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointOfInterestArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name automotive_navigation_msgs-msg:<PointOfInterestArray> is deprecated: use automotive_navigation_msgs-msg:PointOfInterestArray instead.")))
...
(cl:defmethod point_list-val ((m <PointOfInterestArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_navigation_msgs-msg:point_list-val is deprecated.  Use automotive_navigation_msgs-msg:point_list instead.")
  (point_list m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PointOfInterestArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'point_list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'automotive_navigation_msgs-msg:PointOfInterest))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PointOfInterestArray>)))
  ...
  "automotive_navigation_msgs/PointOfInterestArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PointOfInterestArray)))
  "Returns string type for a message object of type 'PointOfInterestArray"
  "automotive_navigation_msgs/PointOfInterestArray")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PointOfInterestArray>)))
  ...
  (cl:format cl:nil "# Point of Interest List Message~%# Contains an array of points of interest~%# update_num is incremented each time a new list is sent~%~%std_msgs/Header header~%uint16 update_num~%automotive_navigation_msgs/PointOfInterest[] point_list~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: automotive_navigation_msgs/PointOfInterest~%# Point of Interest Message~%# Contains the guid, latitude, longitude, and other information for a point of interest~%~%uint64 guid        # Unique Id for this point~%~%float64 latitude   # Latitude (degrees)~%float64 longitude  # Longitude (degrees)~%~%string params      # List of parameter:value pairs~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PointOfInterestArray)))
  "Returns full string definition for message of type 'PointOfInterestArray"
  (cl:format cl:nil "# Point of Interest List Message~%# Contains an array of points of interest~%# update_num is incremented each time a new list is sent~%~%std_msgs/Header header~%uint16 update_num~%automotive_navigation_msgs/PointOfInterest[] point_list~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: automotive_navigation_msgs/PointOfInterest~%# Point of Interest Message~%# Contains the guid, latitude, longitude, and other information for a point of interest~%~%uint64 guid        # Unique Id for this point~%~%float64 latitude   # Latitude (degrees)~%float64 longitude  # Longitude (degrees)~%~%string params      # List of parameter:value pairs~%~%~%~%"))
