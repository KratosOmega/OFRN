...
(cl:defclass <PointOfInterestResponse> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (point_statuses
    ...
    :type (cl:vector automotive_navigation_msgs-msg:PointOfInterestStatus)
   :initform (cl:make-array 0 :element-type 'automotive_navigation_msgs-msg:PointOfInterestStatus :initial-element (cl:make-instance 'automotive_navigation_msgs-msg:PointOfInterestStatus))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PointOfInterestResponse>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointOfInterestResponse)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name automotive_navigation_msgs-msg:<PointOfInterestResponse> is deprecated: use automotive_navigation_msgs-msg:PointOfInterestResponse instead.")))
...
(cl:defmethod name-val ((m <PointOfInterestResponse>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_navigation_msgs-msg:name-val is deprecated.  Use automotive_navigation_msgs-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'module_name-val :lambda-list '(m))
(cl:defmethod module_name-val ((m <PointOfInterestResponse>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_navigation_msgs-msg:module_name-val is deprecated.  Use automotive_navigation_msgs-msg:module_name instead.")
  (module_name m))

(cl:ensure-generic-function 'requestId-val :lambda-list '(m))
(cl:defmethod requestId-val ((m <PointOfInterestResponse>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_navigation_msgs-msg:requestId-val is deprecated.  Use automotive_navigation_msgs-msg:requestId instead.")
  (requestId m))

(cl:ensure-generic-function 'update_num-val :lambda-list '(m))
(cl:defmethod update_num-val ((m <PointOfInterestResponse>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_navigation_msgs-msg:update_num-val is deprecated.  Use automotive_navigation_msgs-msg:update_num instead.")
  (update_num m))

(cl:ensure-generic-function 'point_statuses-val :lambda-list '(m))
(cl:defmethod point_statuses-val ((m <PointOfInterestResponse>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_navigation_msgs-msg:point_statuses-val is deprecated.  Use automotive_navigation_msgs-msg:point_statuses instead.")
  (point_statuses m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PointOfInterestResponse>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'point_statuses)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'automotive_navigation_msgs-msg:PointOfInterestStatus))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PointOfInterestResponse>)))
  ...
  "automotive_navigation_msgs/PointOfInterestResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PointOfInterestResponse)))
  "Returns string type for a message object of type 'PointOfInterestResponse"
  "automotive_navigation_msgs/PointOfInterestResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PointOfInterestResponse>)))
  ...
  (cl:format cl:nil "# Point of Interest Response Message~%# Contains status information about the points within the threshold~%~%std_msgs/Header header~%~%string name             # Name of the point of interest list~%~%string module_name      # module name of the requesting node~%~%uint16 requestId        # Unique id of this request~%~%uint16 update_num       # The update number of the point list to use~%~%automotive_navigation_msgs/PointOfInterestStatus[] point_statuses # The status information~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: automotive_navigation_msgs/PointOfInterestStatus~%# Point of Interest Status Message~%# Contains the distance, heading, a localized position of a point of interest~%~%uint64 guid        # Unique Id for this point~%~%float32 distance   # Great circle distance (meters)~%float32 heading    # Heading (radians)~%float32 x_position # Distance in front of the vehicle (meters)~%float32 y_position # Distance to the left of the vehicle (meters)~%~%string params      # List of parameter:value pairs~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PointOfInterestResponse)))
  "Returns full string definition for message of type 'PointOfInterestResponse"
  (cl:format cl:nil "# Point of Interest Response Message~%# Contains status information about the points within the threshold~%~%std_msgs/Header header~%~%string name             # Name of the point of interest list~%~%string module_name      # module name of the requesting node~%~%uint16 requestId        # Unique id of this request~%~%uint16 update_num       # The update number of the point list to use~%~%automotive_navigation_msgs/PointOfInterestStatus[] point_statuses # The status information~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: automotive_navigation_msgs/PointOfInterestStatus~%# Point of Interest Status Message~%# Contains the distance, heading, a localized position of a point of interest~%~%uint64 guid        # Unique Id for this point~%~%float32 distance   # Great circle distance (meters)~%float32 heading    # Heading (radians)~%float32 x_position # Distance in front of the vehicle (meters)~%float32 y_position # Distance to the left of the vehicle (meters)~%~%string params      # List of parameter:value pairs~%~%~%~%"))
