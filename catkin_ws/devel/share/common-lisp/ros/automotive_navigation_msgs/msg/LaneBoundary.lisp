...
(cl:defmethod cl:initialize-instance :after ((m <LaneBoundary>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaneBoundary)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name automotive_navigation_msgs-msg:<LaneBoundary> is deprecated: use automotive_navigation_msgs-msg:LaneBoundary instead.")))

(cl:ensure-generic-function 'style-val :lambda-list '(m))
(cl:defmethod style-val ((m <LaneBoundary>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_navigation_msgs-msg:style-val is deprecated.  Use automotive_navigation_msgs-msg:style instead.")
  (style m))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <LaneBoundary>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_navigation_msgs-msg:color-val is deprecated.  Use automotive_navigation_msgs-msg:color instead.")
  (color m))

(cl:ensure-generic-function 'line-val :lambda-list '(m))
(cl:defmethod line-val ((m <LaneBoundary>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_navigation_msgs-msg:line-val is deprecated.  Use automotive_navigation_msgs-msg:line instead.")
  (line m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LaneBoundary>)))
  ...
  "automotive_navigation_msgs/LaneBoundary")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LaneBoundary)))
  "Returns string type for a message object of type 'LaneBoundary"
  "automotive_navigation_msgs/LaneBoundary")
