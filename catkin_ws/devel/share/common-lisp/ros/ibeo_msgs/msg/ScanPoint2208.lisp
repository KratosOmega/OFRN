...
;//! \htmlinclude ScanPoint2208.msg.html

(cl:defclass <ScanPoint2208> (roslisp-msg-protocol:ros-message)
  ((echo
    :reader echo
    :initarg :echo
    :type cl:fixnum
...
(cl:defclass ScanPoint2208 (<ScanPoint2208>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ScanPoint2208>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ScanPoint2208)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ibeo_msgs-msg:<ScanPoint2208> is deprecated: use ibeo_msgs-msg:ScanPoint2208 instead.")))

(cl:ensure-generic-function 'echo-val :lambda-list '(m))
(cl:defmethod echo-val ((m <ScanPoint2208>))
...
(cl:defmethod layer-val ((m <ScanPoint2208>))
...
(cl:defmethod transparent_point-val ((m <ScanPoint2208>))
...
(cl:defmethod clutter_atmospheric-val ((m <ScanPoint2208>))
...
(cl:defmethod ground-val ((m <ScanPoint2208>))
...
(cl:defmethod dirt-val ((m <ScanPoint2208>))
...
(cl:defmethod horizontal_angle-val ((m <ScanPoint2208>))
...
(cl:defmethod radial_distance-val ((m <ScanPoint2208>))
...
(cl:defmethod echo_pulse_width-val ((m <ScanPoint2208>))
  ...
  (echo_pulse_width m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ScanPoint2208>) ostream)
  "Serializes a message object of type '<ScanPoint2208>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ScanPoint2208>) istream)
  "Deserializes a message object of type '<ScanPoint2208>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ScanPoint2208>)))
  "Returns string type for a message object of type '<ScanPoint2208>"
  "ibeo_msgs/ScanPoint2208")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ScanPoint2208)))
  "Returns string type for a message object of type 'ScanPoint2208"
  "ibeo_msgs/ScanPoint2208")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ScanPoint2208>)))
  "Returns md5sum for a message object of type '<ScanPoint2208>"
  "fdc87d398fc0cfdeedf159386b96c70f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ScanPoint2208)))
  "Returns md5sum for a message object of type 'ScanPoint2208"
  "fdc87d398fc0cfdeedf159386b96c70f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ScanPoint2208>)))
  "Returns full string definition for message of type '<ScanPoint2208>"
  (cl:format cl:nil "uint8 echo~%uint8 layer~%bool transparent_point~%bool clutter_atmospheric~%bool ground~%bool dirt~%int16 horizontal_angle~%uint16 radial_distance~%uint16 echo_pulse_width~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ScanPoint2208)))
  "Returns full string definition for message of type 'ScanPoint2208"
  (cl:format cl:nil "uint8 echo~%uint8 layer~%bool transparent_point~%bool clutter_atmospheric~%bool ground~%bool dirt~%int16 horizontal_angle~%uint16 radial_distance~%uint16 echo_pulse_width~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ScanPoint2208>))
  (cl:+ 0
     1
     1
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ScanPoint2208>))
  "Converts a ROS message object to a list"
  (cl:list 'ScanPoint2208
