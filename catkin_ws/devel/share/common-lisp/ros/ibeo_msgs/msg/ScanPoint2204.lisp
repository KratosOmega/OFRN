...
;//! \htmlinclude ScanPoint2204.msg.html

(cl:defclass <ScanPoint2204> (roslisp-msg-protocol:ros-message)
  ((x_position
    :reader x_position
    :initarg :x_position
    :type cl:float
...
(cl:defclass ScanPoint2204 (<ScanPoint2204>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ScanPoint2204>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ScanPoint2204)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ibeo_msgs-msg:<ScanPoint2204> is deprecated: use ibeo_msgs-msg:ScanPoint2204 instead.")))

(cl:ensure-generic-function 'x_position-val :lambda-list '(m))
(cl:defmethod x_position-val ((m <ScanPoint2204>))
...
(cl:defmethod y_position-val ((m <ScanPoint2204>))
...
(cl:defmethod z_position-val ((m <ScanPoint2204>))
...
(cl:defmethod echo_width-val ((m <ScanPoint2204>))
...
(cl:defmethod device_id-val ((m <ScanPoint2204>))
...
(cl:defmethod layer-val ((m <ScanPoint2204>))
...
(cl:defmethod echo-val ((m <ScanPoint2204>))
...
(cl:defmethod time_offset-val ((m <ScanPoint2204>))
...
(cl:defmethod ground-val ((m <ScanPoint2204>))
...
(cl:defmethod dirt-val ((m <ScanPoint2204>))
...
(cl:defmethod precipitation-val ((m <ScanPoint2204>))
  ...
  (precipitation m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ScanPoint2204>) ostream)
  "Serializes a message object of type '<ScanPoint2204>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ScanPoint2204>) istream)
  "Deserializes a message object of type '<ScanPoint2204>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ScanPoint2204>)))
  "Returns string type for a message object of type '<ScanPoint2204>"
  "ibeo_msgs/ScanPoint2204")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ScanPoint2204)))
  "Returns string type for a message object of type 'ScanPoint2204"
  "ibeo_msgs/ScanPoint2204")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ScanPoint2204>)))
  "Returns md5sum for a message object of type '<ScanPoint2204>"
  "02c1d60c0e83cb7b61e52f5aa4db4895")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ScanPoint2204)))
  "Returns md5sum for a message object of type 'ScanPoint2204"
  "02c1d60c0e83cb7b61e52f5aa4db4895")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ScanPoint2204>)))
  "Returns full string definition for message of type '<ScanPoint2204>"
  (cl:format cl:nil "float32 x_position~%float32 y_position~%float32 z_position~%float32 echo_width~%uint8 device_id~%uint8 layer~%uint8 echo~%uint32 time_offset~%bool ground~%bool dirt~%bool precipitation~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ScanPoint2204)))
  "Returns full string definition for message of type 'ScanPoint2204"
  (cl:format cl:nil "float32 x_position~%float32 y_position~%float32 z_position~%float32 echo_width~%uint8 device_id~%uint8 layer~%uint8 echo~%uint32 time_offset~%bool ground~%bool dirt~%bool precipitation~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ScanPoint2204>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ScanPoint2204>))
  "Converts a ROS message object to a list"
  (cl:list 'ScanPoint2204
