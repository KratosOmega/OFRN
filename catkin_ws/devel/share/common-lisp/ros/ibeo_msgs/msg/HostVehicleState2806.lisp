...
;//! \htmlinclude HostVehicleState2806.msg.html

(cl:defclass <HostVehicleState2806> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass HostVehicleState2806 (<HostVehicleState2806>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <HostVehicleState2806>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'HostVehicleState2806)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ibeo_msgs-msg:<HostVehicleState2806> is deprecated: use ibeo_msgs-msg:HostVehicleState2806 instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <HostVehicleState2806>))
...
(cl:defmethod ibeo_header-val ((m <HostVehicleState2806>))
...
(cl:defmethod timestamp-val ((m <HostVehicleState2806>))
...
(cl:defmethod distance_x-val ((m <HostVehicleState2806>))
...
(cl:defmethod distance_y-val ((m <HostVehicleState2806>))
...
(cl:defmethod course_angle-val ((m <HostVehicleState2806>))
...
(cl:defmethod longitudinal_velocity-val ((m <HostVehicleState2806>))
...
(cl:defmethod yaw_rate-val ((m <HostVehicleState2806>))
...
(cl:defmethod steering_wheel_angle-val ((m <HostVehicleState2806>))
...
(cl:defmethod cross_acceleration-val ((m <HostVehicleState2806>))
...
(cl:defmethod front_wheel_angle-val ((m <HostVehicleState2806>))
...
(cl:defmethod vehicle_width-val ((m <HostVehicleState2806>))
...
(cl:defmethod vehicle_front_to_front_axle-val ((m <HostVehicleState2806>))
...
(cl:defmethod rear_axle_to_front_axle-val ((m <HostVehicleState2806>))
...
(cl:defmethod rear_axle_to_vehicle_rear-val ((m <HostVehicleState2806>))
...
(cl:defmethod steer_ratio_poly_0-val ((m <HostVehicleState2806>))
...
(cl:defmethod steer_ratio_poly_1-val ((m <HostVehicleState2806>))
...
(cl:defmethod steer_ratio_poly_2-val ((m <HostVehicleState2806>))
...
(cl:defmethod steer_ratio_poly_3-val ((m <HostVehicleState2806>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <HostVehicleState2806>) ostream)
  "Serializes a message object of type '<HostVehicleState2806>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HostVehicleState2806>) istream)
  "Deserializes a message object of type '<HostVehicleState2806>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HostVehicleState2806>)))
  "Returns string type for a message object of type '<HostVehicleState2806>"
  "ibeo_msgs/HostVehicleState2806")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HostVehicleState2806)))
  "Returns string type for a message object of type 'HostVehicleState2806"
  "ibeo_msgs/HostVehicleState2806")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HostVehicleState2806>)))
  "Returns md5sum for a message object of type '<HostVehicleState2806>"
  "eb0d091be510898713734e1e3cbc956b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HostVehicleState2806)))
  "Returns md5sum for a message object of type 'HostVehicleState2806"
  "eb0d091be510898713734e1e3cbc956b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HostVehicleState2806>)))
  "Returns full string definition for message of type '<HostVehicleState2806>"
  (cl:format cl:nil "Header header~%~%IbeoDataHeader ibeo_header~%time timestamp~%int32 distance_x~%int32 distance_y~%float32 course_angle~%float32 longitudinal_velocity~%float32 yaw_rate~%float32 steering_wheel_angle~%float32 cross_acceleration~%float32 front_wheel_angle~%float32 vehicle_width~%float32 vehicle_front_to_front_axle~%float32 rear_axle_to_front_axle~%float32 rear_axle_to_vehicle_rear~%float32 steer_ratio_poly_0~%float32 steer_ratio_poly_1~%float32 steer_ratio_poly_2~%float32 steer_ratio_poly_3~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: ibeo_msgs/IbeoDataHeader~%uint32 previous_message_size~%uint32 message_size~%uint8 device_id~%uint16 data_type_id~%time stamp~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HostVehicleState2806)))
  "Returns full string definition for message of type 'HostVehicleState2806"
  (cl:format cl:nil "Header header~%~%IbeoDataHeader ibeo_header~%time timestamp~%int32 distance_x~%int32 distance_y~%float32 course_angle~%float32 longitudinal_velocity~%float32 yaw_rate~%float32 steering_wheel_angle~%float32 cross_acceleration~%float32 front_wheel_angle~%float32 vehicle_width~%float32 vehicle_front_to_front_axle~%float32 rear_axle_to_front_axle~%float32 rear_axle_to_vehicle_rear~%float32 steer_ratio_poly_0~%float32 steer_ratio_poly_1~%float32 steer_ratio_poly_2~%float32 steer_ratio_poly_3~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: ibeo_msgs/IbeoDataHeader~%uint32 previous_message_size~%uint32 message_size~%uint8 device_id~%uint16 data_type_id~%time stamp~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <HostVehicleState2806>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <HostVehicleState2806>))
  "Converts a ROS message object to a list"
  (cl:list 'HostVehicleState2806
