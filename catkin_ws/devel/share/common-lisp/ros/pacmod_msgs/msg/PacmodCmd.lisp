...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PacmodCmd>)))
  ...
  "c4197651090f1dbf0dfef39c46c42bea")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PacmodCmd)))
  "Returns md5sum for a message object of type 'PacmodCmd"
  "c4197651090f1dbf0dfef39c46c42bea")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PacmodCmd>)))
  ...
  (cl:format cl:nil "Header header~%~%float64 f64_cmd~%uint16 ui16_cmd~%bool enable~%bool clear~%bool ignore~%~%uint16 TURN_RIGHT = 0~%uint16 TURN_NONE = 1~%uint16 TURN_LEFT = 2~%~%uint16 SHIFT_PARK = 0~%uint16 SHIFT_REVERSE = 1~%uint16 SHIFT_NEUTRAL = 2~%uint16 SHIFT_FORWARD = 3~%uint16 SHIFT_HIGH = 3 # For Polaris Ranger~%uint16 SHIFT_LOW = 4~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PacmodCmd)))
  "Returns full string definition for message of type 'PacmodCmd"
  (cl:format cl:nil "Header header~%~%float64 f64_cmd~%uint16 ui16_cmd~%bool enable~%bool clear~%bool ignore~%~%uint16 TURN_RIGHT = 0~%uint16 TURN_NONE = 1~%uint16 TURN_LEFT = 2~%~%uint16 SHIFT_PARK = 0~%uint16 SHIFT_REVERSE = 1~%uint16 SHIFT_NEUTRAL = 2~%uint16 SHIFT_FORWARD = 3~%uint16 SHIFT_HIGH = 3 # For Polaris Ranger~%uint16 SHIFT_LOW = 4~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
