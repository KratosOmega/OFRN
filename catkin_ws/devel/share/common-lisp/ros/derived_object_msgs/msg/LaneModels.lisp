...
(cl:defclass <LaneModels> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (left_lane
    :reader left_lane
    :initarg :left_lane
    :type derived_object_msgs-msg:Lane
    :initform (cl:make-instance 'derived_object_msgs-msg:Lane))
   (right_lane
    :reader right_lane
    :initarg :right_lane
    :type derived_object_msgs-msg:Lane
   ...
   (additional_lanes
    ...
    :type (cl:vector derived_object_msgs-msg:Lane)
   :initform (cl:make-array 0 :element-type 'derived_object_msgs-msg:Lane :initial-element (cl:make-instance 'derived_object_msgs-msg:Lane))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LaneModels>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaneModels)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name derived_object_msgs-msg:<LaneModels> is deprecated: use derived_object_msgs-msg:LaneModels instead.")))
...
(cl:defmethod left_lane-val ((m <LaneModels>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader derived_object_msgs-msg:left_lane-val is deprecated.  Use derived_object_msgs-msg:left_lane instead.")
  (left_lane m))

(cl:ensure-generic-function 'right_lane-val :lambda-list '(m))
(cl:defmethod right_lane-val ((m <LaneModels>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader derived_object_msgs-msg:right_lane-val is deprecated.  Use derived_object_msgs-msg:right_lane instead.")
  (right_lane m))

(cl:ensure-generic-function 'additional_lanes-val :lambda-list '(m))
(cl:defmethod additional_lanes-val ((m <LaneModels>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader derived_object_msgs-msg:additional_lanes-val is deprecated.  Use derived_object_msgs-msg:additional_lanes instead.")
  (additional_lanes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LaneModels>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'additional_lanes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'derived_object_msgs-msg:Lane))
