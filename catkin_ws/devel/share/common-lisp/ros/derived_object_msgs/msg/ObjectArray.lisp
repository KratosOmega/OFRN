...
(cl:defclass <ObjectArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (objects
    :reader objects
    :initarg :objects
    :type (cl:vector derived_object_msgs-msg:Object)
   :initform (cl:make-array 0 :element-type 'derived_object_msgs-msg:Object :initial-element (cl:make-instance 'derived_object_msgs-msg:Object))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ObjectArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name derived_object_msgs-msg:<ObjectArray> is deprecated: use derived_object_msgs-msg:ObjectArray instead.")))
...
(cl:defmethod objects-val ((m <ObjectArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader derived_object_msgs-msg:objects-val is deprecated.  Use derived_object_msgs-msg:objects instead.")
  (objects m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObjectArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'derived_object_msgs-msg:Object))
