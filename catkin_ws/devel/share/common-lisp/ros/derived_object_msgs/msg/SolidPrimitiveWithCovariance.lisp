...
(cl:defmethod cl:initialize-instance :after ((m <SolidPrimitiveWithCovariance>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SolidPrimitiveWithCovariance)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name derived_object_msgs-msg:<SolidPrimitiveWithCovariance> is deprecated: use derived_object_msgs-msg:SolidPrimitiveWithCovariance instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <SolidPrimitiveWithCovariance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader derived_object_msgs-msg:type-val is deprecated.  Use derived_object_msgs-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'dimensions-val :lambda-list '(m))
(cl:defmethod dimensions-val ((m <SolidPrimitiveWithCovariance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader derived_object_msgs-msg:dimensions-val is deprecated.  Use derived_object_msgs-msg:dimensions instead.")
  (dimensions m))

(cl:ensure-generic-function 'covariance-val :lambda-list '(m))
(cl:defmethod covariance-val ((m <SolidPrimitiveWithCovariance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader derived_object_msgs-msg:covariance-val is deprecated.  Use derived_object_msgs-msg:covariance instead.")
  (covariance m))
