...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ScheduledReportRatesReq>)))
  ...
  (cl:format cl:nil "Header header~%bool confirm~%ReportIndex index_1~%uint16 index_1_report_time    # How often to publish the requested report in ms.~%ReportIndex index_2           # If this is set to REPORT_NONE_INDEX then only the first index will be reported.~%uint16 index_2_report_time    # Ignored if index_2 is set to REPORT_NONE_INDEX.~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: kartech_linear_actuator_msgs/ReportIndex~%uint8 POSITION_REPORT_INDEX = 128~%uint8 MOTOR_CURRENT_REPORT_INDEX = 129~%uint8 ENHANCED_POSITION_REPORT_INDEX = 152~%uint8 UNIQUE_DEVICE_ID_REPORTS_INDEX = 167~%uint8 SOFTWARE_REVISION_REPORT_INDEX = 229~%uint8 ZEROING_MESSAGE_REPORT_INDEX = 238~%~%uint8 report_index~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ScheduledReportRatesReq)))
  "Returns full string definition for message of type 'ScheduledReportRatesReq"
  (cl:format cl:nil "Header header~%bool confirm~%ReportIndex index_1~%uint16 index_1_report_time    # How often to publish the requested report in ms.~%ReportIndex index_2           # If this is set to REPORT_NONE_INDEX then only the first index will be reported.~%uint16 index_2_report_time    # Ignored if index_2 is set to REPORT_NONE_INDEX.~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: kartech_linear_actuator_msgs/ReportIndex~%uint8 POSITION_REPORT_INDEX = 128~%uint8 MOTOR_CURRENT_REPORT_INDEX = 129~%uint8 ENHANCED_POSITION_REPORT_INDEX = 152~%uint8 UNIQUE_DEVICE_ID_REPORTS_INDEX = 167~%uint8 SOFTWARE_REVISION_REPORT_INDEX = 229~%uint8 ZEROING_MESSAGE_REPORT_INDEX = 238~%~%uint8 report_index~%~%~%"))
