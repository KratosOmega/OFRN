...
(cl:defmethod cl:initialize-instance :after ((m <BrakeFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BrakeFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name automotive_platform_msgs-msg:<BrakeFeedback> is deprecated: use automotive_platform_msgs-msg:BrakeFeedback instead.")))
