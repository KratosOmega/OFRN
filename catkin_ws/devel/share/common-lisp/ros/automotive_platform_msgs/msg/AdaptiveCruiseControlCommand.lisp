...
(cl:defmethod cl:initialize-instance :after ((m <AdaptiveCruiseControlCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AdaptiveCruiseControlCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name automotive_platform_msgs-msg:<AdaptiveCruiseControlCommand> is deprecated: use automotive_platform_msgs-msg:AdaptiveCruiseControlCommand instead.")))
...
(cl:defmethod msg_counter-val ((m <AdaptiveCruiseControlCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_platform_msgs-msg:msg_counter-val is deprecated.  Use automotive_platform_msgs-msg:msg_counter instead.")
  (msg_counter m))

(cl:ensure-generic-function 'set_speed-val :lambda-list '(m))
(cl:defmethod set_speed-val ((m <AdaptiveCruiseControlCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_platform_msgs-msg:set_speed-val is deprecated.  Use automotive_platform_msgs-msg:set_speed instead.")
  (set_speed m))

(cl:ensure-generic-function 'set-val :lambda-list '(m))
(cl:defmethod set-val ((m <AdaptiveCruiseControlCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_platform_msgs-msg:set-val is deprecated.  Use automotive_platform_msgs-msg:set instead.")
  (set m))

(cl:ensure-generic-function 'resume-val :lambda-list '(m))
(cl:defmethod resume-val ((m <AdaptiveCruiseControlCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_platform_msgs-msg:resume-val is deprecated.  Use automotive_platform_msgs-msg:resume instead.")
  (resume m))

(cl:ensure-generic-function 'cancel-val :lambda-list '(m))
(cl:defmethod cancel-val ((m <AdaptiveCruiseControlCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_platform_msgs-msg:cancel-val is deprecated.  Use automotive_platform_msgs-msg:cancel instead.")
  (cancel m))

(cl:ensure-generic-function 'speed_up-val :lambda-list '(m))
(cl:defmethod speed_up-val ((m <AdaptiveCruiseControlCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_platform_msgs-msg:speed_up-val is deprecated.  Use automotive_platform_msgs-msg:speed_up instead.")
  (speed_up m))

(cl:ensure-generic-function 'slow_down-val :lambda-list '(m))
(cl:defmethod slow_down-val ((m <AdaptiveCruiseControlCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_platform_msgs-msg:slow_down-val is deprecated.  Use automotive_platform_msgs-msg:slow_down instead.")
  (slow_down m))

(cl:ensure-generic-function 'further-val :lambda-list '(m))
(cl:defmethod further-val ((m <AdaptiveCruiseControlCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_platform_msgs-msg:further-val is deprecated.  Use automotive_platform_msgs-msg:further instead.")
  (further m))

(cl:ensure-generic-function 'closer-val :lambda-list '(m))
(cl:defmethod closer-val ((m <AdaptiveCruiseControlCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_platform_msgs-msg:closer-val is deprecated.  Use automotive_platform_msgs-msg:closer instead.")
  (closer m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AdaptiveCruiseControlCommand>)))
  ...
  "automotive_platform_msgs/AdaptiveCruiseControlCommand")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AdaptiveCruiseControlCommand)))
  "Returns string type for a message object of type 'AdaptiveCruiseControlCommand"
  "automotive_platform_msgs/AdaptiveCruiseControlCommand")
