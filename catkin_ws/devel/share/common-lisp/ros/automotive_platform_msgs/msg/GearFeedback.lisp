...
(cl:defmethod cl:initialize-instance :after ((m <GearFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GearFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name automotive_platform_msgs-msg:<GearFeedback> is deprecated: use automotive_platform_msgs-msg:GearFeedback instead.")))
...
(cl:defmethod current_gear-val ((m <GearFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader automotive_platform_msgs-msg:current_gear-val is deprecated.  Use automotive_platform_msgs-msg:current_gear instead.")
  (current_gear m))
