...
(cl:defmethod cl:initialize-instance :after ((m <ThrottleFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ThrottleFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name automotive_platform_msgs-msg:<ThrottleFeedback> is deprecated: use automotive_platform_msgs-msg:ThrottleFeedback instead.")))
