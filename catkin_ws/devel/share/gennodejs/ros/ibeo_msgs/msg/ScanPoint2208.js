...
class ScanPoint2208 {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ScanPoint2208(null);
  ...
  static datatype() {
    ...
    return 'ibeo_msgs/ScanPoint2208';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'fdc87d398fc0cfdeedf159386b96c70f';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ScanPoint2208(null);
