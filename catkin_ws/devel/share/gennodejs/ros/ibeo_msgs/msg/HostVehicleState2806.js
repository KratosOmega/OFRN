...
class HostVehicleState2806 {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new HostVehicleState2806(null);
  ...
  static datatype() {
    ...
    return 'ibeo_msgs/HostVehicleState2806';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'eb0d091be510898713734e1e3cbc956b';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HostVehicleState2806(null);
...
module.exports = HostVehicleState2806;
