...
class Size2D {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint16(obj.size_x, buffer, bufferOffset);
    // Serialize message field [size_y]
    bufferOffset = _serializer.uint16(obj.size_y, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Size2D(null);
    // Deserialize message field [size_x]
    data.size_x = _deserializer.uint16(buffer, bufferOffset);
    // Deserialize message field [size_y]
    data.size_y = _deserializer.uint16(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Size2D(null);
