...
class PlanFootstepsResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FootstepArray.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PlanFootstepsResult(null);
    // Deserialize message field [result]
    data.result = FootstepArray.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += FootstepArray.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanFootstepsResult(null);
    if (msg.result !== undefined) {
      resolved.result = FootstepArray.Resolve(msg.result)
    }
    else {
      resolved.result = new FootstepArray()
    }
...
module.exports = PlanFootstepsResult;
