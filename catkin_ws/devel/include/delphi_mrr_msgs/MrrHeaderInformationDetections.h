...
struct MrrHeaderInformationDetections_
{
  ...
  _header_type header;
   ...
   typedef uint16_t _canAlignUodatesDone_type;
  _canAlignUodatesDone_type canAlignUodatesDone;

   typedef uint16_t _canScanIndex_type;
  _canScanIndex_type canScanIndex;

   typedef uint8_t _canNumberOfDet_type;
  _canNumberOfDet_type canNumberOfDet;

   typedef uint8_t _canLookId_type;
  _canLookId_type canLookId;

   typedef uint16_t _canLookIndex_type;
  _canLookIndex_type canLookIndex;
...
struct MD5Sum< ::delphi_mrr_msgs::MrrHeaderInformationDetections_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xb9a60141c38bd4aeULL;
  static const uint64_t static_value2 = 0x43dc825836099636ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::delphi_mrr_msgs::MrrHeaderInformationDetections_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.canAlignUodatesDone);
      stream.next(m.canScanIndex);
      stream.next(m.canNumberOfDet);
      stream.next(m.canLookId);
      stream.next(m.canLookIndex);
    }
...
struct Printer< ::delphi_mrr_msgs::MrrHeaderInformationDetections_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::delphi_mrr_msgs::MrrHeaderInformationDetections_<ContainerAllocator>& v)
  {
    ...
    s << indent << "canAlignUodatesDone: ";
    Printer<uint16_t>::stream(s, indent + "  ", v.canAlignUodatesDone);
    s << indent << "canScanIndex: ";
    Printer<uint16_t>::stream(s, indent + "  ", v.canScanIndex);
    s << indent << "canNumberOfDet: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.canNumberOfDet);
    s << indent << "canLookId: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.canLookId);
    s << indent << "canLookIndex: ";
    Printer<uint16_t>::stream(s, indent + "  ", v.canLookIndex);
  }
};
