...
struct MrrHeaderTimestamps_
{
  ...
  MrrHeaderTimestamps_()
    : header()
    , canDetTimeSinceMeas(0.0)
    , canSensorTimeStamp(0.0)  {
    }
  ...
  _header_type header;
   ...
   typedef float _canDetTimeSinceMeas_type;
  _canDetTimeSinceMeas_type canDetTimeSinceMeas;

   typedef float _canSensorTimeStamp_type;
  _canSensorTimeStamp_type canSensorTimeStamp;
...
struct MD5Sum< ::delphi_mrr_msgs::MrrHeaderTimestamps_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xa03518981fcb6610ULL;
  static const uint64_t static_value2 = 0x0852bdef78eeb945ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::delphi_mrr_msgs::MrrHeaderTimestamps_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.canDetTimeSinceMeas);
      stream.next(m.canSensorTimeStamp);
    }
...
struct Printer< ::delphi_mrr_msgs::MrrHeaderTimestamps_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::delphi_mrr_msgs::MrrHeaderTimestamps_<ContainerAllocator>& v)
  {
    ...
    s << indent << "canDetTimeSinceMeas: ";
    Printer<float>::stream(s, indent + "  ", v.canDetTimeSinceMeas);
    s << indent << "canSensorTimeStamp: ";
    Printer<float>::stream(s, indent + "  ", v.canSensorTimeStamp);
  }
};
