// Generated by gencpp from file ibeo_msgs/HostVehicleState2806.msg
// DO NOT EDIT!


#ifndef IBEO_MSGS_MESSAGE_HOSTVEHICLESTATE2806_H
#define IBEO_MSGS_MESSAGE_HOSTVEHICLESTATE2806_H
...
{
  typedef HostVehicleState2806_<ContainerAllocator> Type;

  HostVehicleState2806_()
    : header()
    , ibeo_header()
    , timestamp()
    , distance_x(0)
  ...
  HostVehicleState2806_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , ibeo_header(_alloc)
    , timestamp()
    , distance_x(0)
  ...
  typedef boost::shared_ptr< ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> const> ConstPtr;

}; // struct HostVehicleState2806_

typedef ::ibeo_msgs::HostVehicleState2806_<std::allocator<void> > HostVehicleState2806;

typedef boost::shared_ptr< ::ibeo_msgs::HostVehicleState2806 > HostVehicleState2806Ptr;
typedef boost::shared_ptr< ::ibeo_msgs::HostVehicleState2806 const> HostVehicleState2806ConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xeb0d091be5108987ULL;
  static const uint64_t static_value2 = 0x13734e1e3cbc956bULL;
};

template<class ContainerAllocator>
struct DataType< ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ibeo_msgs::HostVehicleState2806_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // IBEO_MSGS_MESSAGE_HOSTVEHICLESTATE2806_H
