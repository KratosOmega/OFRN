// Generated by gencpp from file ibeo_msgs/ScanData2205.msg
// DO NOT EDIT!


#ifndef IBEO_MSGS_MESSAGE_SCANDATA2205_H
#define IBEO_MSGS_MESSAGE_SCANDATA2205_H
...
{
  typedef ScanData2205_<ContainerAllocator> Type;
  ...
  ScanData2205_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , ibeo_header(_alloc)
    , scan_start_time()
    , scan_end_time_offset(0)
  ...
  _scan_start_time_type scan_start_time;
   ...
   typedef uint8_t _scan_end_time_offset_type;
  ...
  _scan_points_type scan_points;
   ...
   typedef uint8_t _number_of_scanner_infos_type;
  _number_of_scanner_infos_type number_of_scanner_infos;

   typedef std::vector< ::ibeo_msgs::ScannerInfo2205_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ibeo_msgs::ScannerInfo2205_<ContainerAllocator> >::other >  _scanner_info_list_type;
  _scanner_info_list_type scanner_info_list;

   typedef std::vector< ::ibeo_msgs::ScanPoint2205_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ibeo_msgs::ScanPoint2205_<ContainerAllocator> >::other >  _scan_point_list_type;
  ...
  typedef boost::shared_ptr< ::ibeo_msgs::ScanData2205_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ibeo_msgs::ScanData2205_<ContainerAllocator> const> ConstPtr;

}; // struct ScanData2205_

typedef ::ibeo_msgs::ScanData2205_<std::allocator<void> > ScanData2205;

typedef boost::shared_ptr< ::ibeo_msgs::ScanData2205 > ScanData2205Ptr;
typedef boost::shared_ptr< ::ibeo_msgs::ScanData2205 const> ScanData2205ConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ibeo_msgs::ScanData2205_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ibeo_msgs::ScanData2205_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ibeo_msgs::ScanData2205_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ibeo_msgs::ScanData2205_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ibeo_msgs::ScanData2205_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ibeo_msgs::ScanData2205_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ibeo_msgs::ScanData2205_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ibeo_msgs::ScanData2205_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ibeo_msgs::ScanData2205_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ibeo_msgs::ScanData2205_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xdd96693e46c44a2bULL;
  static const uint64_t static_value2 = 0x405ce82587e7e698ULL;
};

template<class ContainerAllocator>
struct DataType< ::ibeo_msgs::ScanData2205_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ibeo_msgs::ScanData2205_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ibeo_msgs::ScanData2205_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ibeo_msgs::ScanData2205_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ibeo_msgs::ScanData2205_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    Printer<uint8_t>::stream(s, indent + "  ", v.scan_end_time_offset);
    s << indent << "fused_scan: ";
    ...
    Printer<uint8_t>::stream(s, indent + "  ", v.number_of_scanner_infos);
    ...
    for (size_t i = 0; i < v.scanner_info_list.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::ibeo_msgs::ScannerInfo2205_<ContainerAllocator> >::stream(s, indent + "    ", v.scanner_info_list[i]);
    }
    ...
    for (size_t i = 0; i < v.scan_point_list.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::ibeo_msgs::ScanPoint2205_<ContainerAllocator> >::stream(s, indent + "    ", v.scan_point_list[i]);
    }
  }
};
...
#endif // IBEO_MSGS_MESSAGE_SCANDATA2205_H
