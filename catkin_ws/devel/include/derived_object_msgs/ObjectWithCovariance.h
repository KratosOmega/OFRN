// Generated by gencpp from file derived_object_msgs/ObjectWithCovariance.msg
// DO NOT EDIT!


#ifndef DERIVED_OBJECT_MSGS_MESSAGE_OBJECTWITHCOVARIANCE_H
#define DERIVED_OBJECT_MSGS_MESSAGE_OBJECTWITHCOVARIANCE_H
...
#include <derived_object_msgs/SolidPrimitiveWithCovariance.h>
...
struct ObjectWithCovariance_
{
  ...
  _polygon_type polygon;
   ...
   typedef  ::derived_object_msgs::SolidPrimitiveWithCovariance_<ContainerAllocator>  _shape_type;
  _shape_type shape;
  ...
  typedef boost::shared_ptr< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> const> ConstPtr;

}; // struct ObjectWithCovariance_

typedef ::derived_object_msgs::ObjectWithCovariance_<std::allocator<void> > ObjectWithCovariance;

typedef boost::shared_ptr< ::derived_object_msgs::ObjectWithCovariance > ObjectWithCovariancePtr;
typedef boost::shared_ptr< ::derived_object_msgs::ObjectWithCovariance const> ObjectWithCovarianceConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> >
{
  ...
  static const char* value(const ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x11c5c4e2934ae559ULL;
  static const uint64_t static_value2 = 0x592a68028c8fb34bULL;
};

template<class ContainerAllocator>
struct DataType< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "shape: ";
    s << std::endl;
    Printer< ::derived_object_msgs::SolidPrimitiveWithCovariance_<ContainerAllocator> >::stream(s, indent + "  ", v.shape);
...
#endif // DERIVED_OBJECT_MSGS_MESSAGE_OBJECTWITHCOVARIANCE_H
