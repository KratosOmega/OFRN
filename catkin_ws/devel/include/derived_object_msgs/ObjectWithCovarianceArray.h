// Generated by gencpp from file derived_object_msgs/ObjectWithCovarianceArray.msg
// DO NOT EDIT!


#ifndef DERIVED_OBJECT_MSGS_MESSAGE_OBJECTWITHCOVARIANCEARRAY_H
#define DERIVED_OBJECT_MSGS_MESSAGE_OBJECTWITHCOVARIANCEARRAY_H
...
struct ObjectWithCovarianceArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> >::other >  _objects_type;
  ...
  typedef boost::shared_ptr< ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> const> ConstPtr;

}; // struct ObjectWithCovarianceArray_

typedef ::derived_object_msgs::ObjectWithCovarianceArray_<std::allocator<void> > ObjectWithCovarianceArray;

typedef boost::shared_ptr< ::derived_object_msgs::ObjectWithCovarianceArray > ObjectWithCovarianceArrayPtr;
typedef boost::shared_ptr< ::derived_object_msgs::ObjectWithCovarianceArray const> ObjectWithCovarianceArrayConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> >
{
  ...
  static const char* value(const ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x59dfdf4ed3407a25ULL;
  static const uint64_t static_value2 = 0x58ccbc7f5732bf46ULL;
};

template<class ContainerAllocator>
struct DataType< ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::derived_object_msgs::ObjectWithCovarianceArray_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.objects.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator> >::stream(s, indent + "    ", v.objects[i]);
    }
  }
};
...
#endif // DERIVED_OBJECT_MSGS_MESSAGE_OBJECTWITHCOVARIANCEARRAY_H
