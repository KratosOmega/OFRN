...
struct LaneModels_
{
  ...
  _right_lane_type right_lane;
   ...
   typedef std::vector< ::derived_object_msgs::Lane_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::derived_object_msgs::Lane_<ContainerAllocator> >::other >  _additional_lanes_type;
